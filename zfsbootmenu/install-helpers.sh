...
zfsbootmenu_config=${ZBMCONFIG:-/etc/zfsbootmenu/config.yaml}
...
mapfile -t -O "${#zfsbootmenu_essential_binaries[@]}" zfsbootmenu_essential_binaries < <(yq-go e '.Image.zfsbootmenu_essential_binaries[] | .. style=""' "$zfsbootmenu_config")

zfsbootmenu_optional_binaries=(
  "mbuffer"
  "column"
)
mapfile -t -O "${#zfsbootmenu_optional_binaries[@]}" zfsbootmenu_optional_binaries < <(yq-go e '.Image.zfsbootmenu_optional_binaries[] | .. style=""' "$zfsbootmenu_config")
zfsbootmenu_udev_rules=(
  "90-zfs.rules"
  "69-vdev.rules"
  "60-zvol.rules"
)
mapfile -t -O "${#zfsbootmenu_udev_rules[@]}" zfsbootmenu_udev_rules < <(yq-go e '.Image.zfsbootmenu_udev_rules[] | .. style=""' "$zfsbootmenu_config")
...
mapfile -t -O "${#zfsbootmenu_essential_modules[@]}" zfsbootmenu_essential_modules < <(yq-go e '.Image.zfsbootmenu_essential_modules[] | .. style=""' "$zfsbootmenu_config")

zfsbootmenu_optional_modules=(
  "zlib_deflate"
  "zlib_inflate"
)
mapfile -t -O "${#zfsbootmenu_optional_modules[@]}" zfsbootmenu_optional_modules < <(yq-go e '.Image.zfsbootmenu_optional_modules[] | .. style=""' "$zfsbootmenu_config")

zfsbootmenu_essential_files=(
)
mapfile -t -O "${#zfsbootmenu_essential_files[@]}" zfsbootmenu_essential_files < <(yq-go e '.Image.zfsbootmenu_essential_files[] | .. style=""' "$zfsbootmenu_config")

zfsbootmenu_optional_files=(
  "/etc/zbm-commit-hash"
)
mapfile -t -O "${#zfsbootmenu_optional_files[@]}" zfsbootmenu_optional_files < <(yq-go e '.Image.zfsbootmenu_optional_files[] | .. style=""' "$zfsbootmenu_config")

zfsbootmenu_essential_libraries=()
mapfile -t -O "${#zfsbootmenu_essential_libraries[@]}" zfsbootmenu_essential_libraries < <(yq-go e '.Image.zfsbootmenu_essential_libraries[] | .. style=""' "$zfsbootmenu_config")

zfsbootmenu_optional_libraries=()
mapfile -t -O "${#zfsbootmenu_optional_libraries[@]}" zfsbootmenu_optional_libraries < <(yq-go e '.Image.zfsbootmenu_optional_libraries[] | .. style=""' "$zfsbootmenu_config")

# shellcheck disable=SC2034
zfsbootmenu_keyprompt=$(yq-go e '.Image.zfsbootmenu_keyprompt // ""' "$zfsbootmenu_config")
zfsbootmenu_preprompt+=$(yq-go e '.Hooks.zfsbootmenu_preprompt[]' "$zfsbootmenu_config" | tr '\n' ' ')
zfsbootmenu_early_setup+=$(yq-go e '.Hooks.zfsbootmenu_early_setup[]' "$zfsbootmenu_config" | tr '\n' ' ')
zfsbootmenu_setup+=$(yq-go e '.Hooks.zfsbootmenu_setup[]' "$zfsbootmenu_config" | tr '\n' ' ')
zfsbootmenu_before_kexec+=$(yq-go e '.Hooks.zfsbootmenu_before_kexec[]' "$zfsbootmenu_config" | tr '\n' ' ')
zfsbootmenu_teardown+=$(yq-go e '.Hooks.zfsbootmenu_teardown[]' "$zfsbootmenu_config" | tr '\n' ' ')
